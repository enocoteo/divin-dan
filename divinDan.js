...
function updatescore(){
    ...
    if(myscore > highScore){
        highScore = myscore;
        localStorage.setItem("myHighScoreCookie", highScore);
    }
    console.log (myscore);
    
    $("#highScore").html("High Score: " + highScore);
    $("#score").html("Your Score: " + myscore);
}

function highScoreInit(){
    var high = localStorage.getItem("myHighScoreCookie");
    highScore = high;
    $("#highScore").html("High Score: " + highScore);
    $("#score").html("Your Score: " + myscore);
}
...
function render() {
    ...
    if (currentState === states.Splash) {
        ...
        ctx.strokeText('"Click" to Start',195,215);
    ...
    //var myscore = canvas.getContext("2d");
    //myscore.font = "15px 'Press Start 2P', cursive";
    //myscore.textAlign = "center";
    //myscore.strokeText('Your Score:', 90, 25)
}
